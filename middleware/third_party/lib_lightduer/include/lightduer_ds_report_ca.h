...
duer_status_t duer_ds_report_ca_inc_disconnect_time(duer_u32_t dt); //TODO

duer_status_t duer_ds_report_ca_update_max_connect(duer_u32_t mc);

duer_status_t duer_ds_report_ca_inc_reconnect_count(void);

duer_status_t duer_ds_report_ca_update_avg_latency(duer_u32_t al); //TODO
