...
typedef enum {
    ...
    DUER_DS_LOG_HTTP_DOWNLOAD_STARTED              =  0x201,
    DUER_DS_LOG_HTTP_DOWNLOAD_STOPPED              =  0x202,
    DUER_DS_LOG_HTTP_DOWNLOAD_FINISHED             =  0x203,
    DUER_DS_LOG_HTTP_PERSISTENT_CONN_TIMEOUT       =  0x204,
    DUER_DS_LOG_HTTP_DOWNLOAD_URL                  =  0x205,
    ...
    DUER_DS_LOG_HTTP_COMMON_ERROR                  =  0x311,
    DUER_DS_LOG_HTTP_RECEIVE_FAILED                =  0x312,
    DUER_DS_LOG_HTTP_REDIRECT_FAILED               =  0x313,
