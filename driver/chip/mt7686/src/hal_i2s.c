...
//#ifdef (HAL_I2S_FEATURE_IO_DYNAMIC_SWITCH)//maggie
#ifdef __I2S1_MCLK_PIN__//maggie
...
{
    return hal_i2s_deinit_ex(HAL_I2S_1);
}
...
{
    return hal_i2s_set_eof_ex(HAL_I2S_1);
}
...
{
    return hal_i2s_disable_tx_ex(HAL_I2S_1);
}
...
{
    return hal_i2s_disable_rx_ex(HAL_I2S_1);
}
...
{
    return hal_i2s_disable_audio_top_ex(HAL_I2S_1);
}
...
hal_i2s_status_t hal_i2s_register_tx_callback(hal_i2s_tx_callback_t tx_callback, void *user_data)
{
    ...
    return hal_i2s_register_tx_vfifo_callback_ex(HAL_I2S_1, tx_callback, user_data);
...
{
    return hal_i2s_register_rx_vfifo_callback_ex(HAL_I2S_1, rx_callback, user_data);
}
