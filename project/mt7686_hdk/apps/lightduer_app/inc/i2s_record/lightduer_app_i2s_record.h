...
#ifndef __LIGHTDUER_APP_I2S_REC_H__
#define __LIGHTDUER_APP_I2S_REC_H__
...
typedef enum {
    ...
    I2S_REC_QUEUE_EVENT_START_RECORD,
    I2S_REC_QUEUE_EVENT_STOP_RECORD,
...
typedef struct {
	...
	struct i2s_rec_s handler_array[MAX_I2S_REC_FUNCTIONS];
	uint8_t i2s_rec_queue_reg_num;

} lightduer_app_record_context_t;
...
void lightduer_app_record_task();
...
#endif /*__LIGHTDUER_APP_I2S_REC_H__*/
