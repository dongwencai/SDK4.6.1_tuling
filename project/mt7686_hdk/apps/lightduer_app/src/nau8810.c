...
//default : 0x10
void aucodec_set_mic_gain(uint8_t gain)
{
	aucodec_i2c_write(0x2d, gain);
}
/*vol:0~0xff   DAC Gain Range -127dB to 0dB @ 0.5 increments ,   0 is Digital Mute*/
void aucodec_set_volume(uint8_t vol)
{
	aucodec_i2c_write(0x0b, vol);
}
